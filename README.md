...
app still in development, many features are planned.

my finals are nearby so the development will be a bit slower.
...
All trademarks and intellectual property referenced by the project belong to their respective owners.
